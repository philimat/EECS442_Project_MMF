...
def main():
    ...
    train_path = os.path.abspath(os.path.dirname(__file__)) + '/train_3d_info/training'
    ...
    model_path = os.path.abspath(os.path.dirname(__file__)) + '/3d_info_weights/'
    latest_model = None
    first_epoch = 0
    ...
    for epoch in range(first_epoch+1, epochs+1):
        ...
        for local_batch, local_labels in generator:
            ...
            if passes % 10 == 0:
                print("Epoch %s / %d | batch %s/%s --- [loss: %s]" %(epoch, epochs, curr_batch, total_num_batches, loss.item()))
                passes = 0
